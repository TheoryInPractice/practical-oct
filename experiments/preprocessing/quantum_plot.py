...
def construct_summary_df(data):
    ...
    for counter, dataset_header in enumerate(datasets):
        print('Looking for data', dataset_header)
...
if __name__ == '__main__':
    ...
    results_to_plot = 'results/quantum_preprocessing_results.csv'
    ...
    _save_latex_table(preprocessed_data,
                      'generated_preprocessed_quantum_full.tex')
    print("Wrote generated_preprocessed_quantum_full.tex")
    ...
    _save_latex_table(summary_data,
                      'generated_preprocessed_quantum_summary.tex')
    print("Wrote generated_preprocessed_quantum_summary.tex")
